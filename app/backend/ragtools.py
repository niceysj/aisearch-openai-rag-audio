...
_search_tool_schema = {
    "type": "function",
    "name": "search",
    "description": "Search the knowledge base. The knowledge base is in korean, translate to and from English if " + \
...
def attach_rag_tools(rtmt: RTMiddleTier,
    ...
    rtmt.tools["search"] = Tool(
        ...
        target=lambda args: _search_tool(search_client, semantic_configuration, identifier_field, content_field, embedding_field, use_vector_query, args)
    )
